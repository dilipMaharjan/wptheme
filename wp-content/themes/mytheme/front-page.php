    ...
    <div class="home-featured-instructors-section">
        ...
        <div class="featured-instructors-width-wrapper">
            <div class="featured-instructor featured-instructor-pink">
                <img src="<?php echo bloginfo('template_url')?>/images/john-smith-featured-headshot.png" alt="">
                <h3>John Smith</h3>
            ...
            <div class="featured-instructor featured-instructor-teal">
                <img src="<?php echo bloginfo('template_url')?>/images/leslie-yepp-featured-headshot.png" alt="">
                <h3>Leslie Yepp</h3>
            ...
            <div class="featured-instructor featured-instructor-purple">
                <img src="<?php echo bloginfo('template_url')?>/images/lisa-frank-featured-headshot.png" alt="">
                <h3>Lisa Frank</h3>
